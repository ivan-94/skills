...
- **[deliver-prd](./deliver-prd/SKILL.md)** — 通过父 Agent 编排多个子 Slice 交付 GitHub PRD：独立 worktree、TDD、集成、cross-review、HAT 准备和标记 `HAT-Ready` 的 Draft PR。
...
- **[skill-reviewer](./skill-reviewer/SKILL.md)** — 从智能体使用视角审查技能的触发质量、行为清晰度、冲突、冗余、歧义、弱引导，并给出具体修订路径。
