    ...
    [
        mode(
            ...
            workflow=[
                ...
                step("build_from_sources", "继续执行 build_contract：起草 contract、语义审查、奥卡姆剃刀压缩、写入和机械验证。", reads=["source_map"], writes=["skill_markdown", "frontmatter_description", "review_notes", "validation_evidence"]),
            ],
        ...
        mode(
            ...
            workflow=[
                ...
                step("build_from_inventory", "继续执行 build_contract：翻译行为库存、语义审查、奥卡姆剃刀压缩、写入和机械验证；明确单文件 rewrite 不需要重复确认。", reads=["behavior_inventory"], writes=["skill_markdown", "frontmatter_description", "review_notes", "validation_evidence"]),
            ],
        ...
        mode(
            ...
            workflow=[
                ...
                step("report_review", "按严重级别输出证据、Agent 影响和具体修复建议；除非用户要求，不直接改文件。", writes=["review_notes"]),
            ],
...
examples([
    ...
    example(
        ...
        workflow([
            ...
            step("report", "Return severity-ranked findings and concrete fixes.", reads=["issues"], writes=["review_report"]),
        ])
